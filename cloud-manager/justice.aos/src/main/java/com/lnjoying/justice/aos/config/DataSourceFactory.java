...
import static com.lnjoying.justice.aos.config.DataSourceConfig.TYPE_HANDLERS_PACKAGE;
...
public class DataSourceFactory
{
    ...
    public static SqlSessionFactory createSqlSessionFactory(DataSource dataSource, String map_location) throws Exception
    {
        ...
        sessionFactory.setTypeAliasesPackage("com.lnjoying.justice.aos.db.mapper");
