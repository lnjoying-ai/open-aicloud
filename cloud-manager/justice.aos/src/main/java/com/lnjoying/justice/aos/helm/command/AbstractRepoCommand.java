...
public abstract class AbstractRepoCommand<V> extends AbstractCommand<V>
{

    public static final String COMMAND_REPO = "repo";
    ...
    public AbstractRepoCommand()
    {
        super();
    }

    public AbstractRepoCommand(Logger logger)
    {
        super(logger);
    }
