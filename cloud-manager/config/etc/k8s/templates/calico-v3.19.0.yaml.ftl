...
<#list ClusterCIDR?split(",") as cidrs>
...
<#if NodeSelector??>
      ...
      priorityClassName: ${CalicoNodePriorityClassName!"system-node-critical"}
      initContainers:
...
<#else>
      ...
      # Rancher specific change
      priorityClassName: ${CalicoKubeControllersPriorityClassName!"system-cluster-critical"}
      containers:
        - name: calico-kube-controllers
