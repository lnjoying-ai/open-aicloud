...
public class TblEdgeComputeInfoExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andSoftwareMapIsNull() {
            addCriterion("software_map is null");
            return (Criteria) this;
        }

        public Criteria andSoftwareMapIsNotNull() {
            addCriterion("software_map is not null");
            return (Criteria) this;
        }

        public Criteria andSoftwareMapEqualTo(String value) {
            addCriterion("software_map =", value, "softwareMap");
            return (Criteria) this;
        }

        public Criteria andSoftwareMapNotEqualTo(String value) {
            addCriterion("software_map <>", value, "softwareMap");
            return (Criteria) this;
        }

        public Criteria andSoftwareMapGreaterThan(String value) {
            addCriterion("software_map >", value, "softwareMap");
            return (Criteria) this;
        }

        public Criteria andSoftwareMapGreaterThanOrEqualTo(String value) {
            addCriterion("software_map >=", value, "softwareMap");
            return (Criteria) this;
        }

        public Criteria andSoftwareMapLessThan(String value) {
            addCriterion("software_map <", value, "softwareMap");
            return (Criteria) this;
        }

        public Criteria andSoftwareMapLessThanOrEqualTo(String value) {
            addCriterion("software_map <=", value, "softwareMap");
            return (Criteria) this;
        }

        public Criteria andSoftwareMapLike(String value) {
            addCriterion("software_map like", value, "softwareMap");
            return (Criteria) this;
        }

        public Criteria andSoftwareMapNotLike(String value) {
            addCriterion("software_map not like", value, "softwareMap");
            return (Criteria) this;
        }

        public Criteria andSoftwareMapIn(List<String> values) {
            addCriterion("software_map in", values, "softwareMap");
            return (Criteria) this;
        }

        public Criteria andSoftwareMapNotIn(List<String> values) {
            addCriterion("software_map not in", values, "softwareMap");
            return (Criteria) this;
        }

        public Criteria andSoftwareMapBetween(String value1, String value2) {
            addCriterion("software_map between", value1, value2, "softwareMap");
            return (Criteria) this;
        }

        public Criteria andSoftwareMapNotBetween(String value1, String value2) {
            addCriterion("software_map not between", value1, value2, "softwareMap");
            return (Criteria) this;
        }
        ...
        public Criteria andLabelIsEmptyOrEqualTo(String label, String value) {
            addCriterion("node_id in (SELECT teci.node_id FROM tbl_edge_compute_info teci LEFT JOIN " +
                    "tbl_edge_compute_label_info tecli ON teci.node_id = tecli.node_id and tecli.label_key = '" +
                    label + "' where (tecli.label_value is null or '" + value +
                    "' = ANY(string_to_array(tecli.label_value,','))))");
            return (Criteria) this;
        }

        public Criteria andLabelEqualTo(String label, String value) {
            addCriterion("node_id in (SELECT teci.node_id FROM tbl_edge_compute_info teci LEFT JOIN " +
                    "tbl_edge_compute_label_info tecli ON teci.node_id = tecli.node_id and tecli.label_key = '" +
                    label + "' where ('" + value +
                    "' = ANY(string_to_array(tecli.label_value,','))))");
        ...
        public Criteria andLabelContainLabelKey(String label) {
            addCriterion("node_id in (SELECT teci.node_id FROM tbl_edge_compute_info teci  JOIN " +
                    "tbl_edge_compute_label_info tecli ON teci.node_id = tecli.node_id and tecli.label_key = '" +
                    label + "')");
            return (Criteria) this;
        }
         ...
         * @return
         */
        public Criteria andLabelJoin(String label1, String value1, String label2, String value2) {
            addCriterion("node_id in (SELECT teci.node_id FROM tbl_edge_compute_info teci LEFT JOIN " +
                    "tbl_edge_compute_label_info tecli ON teci.node_id = tecli.node_id and tecli.label_key = '" +
                    label1 + "' where ('" + value1 +
                    "' = ANY(string_to_array(tecli.label_value,',')))  union  " +
                    "SELECT teci.node_id FROM tbl_edge_compute_info teci LEFT JOIN "  +
                    "tbl_edge_compute_label_info tecli ON teci.node_id = tecli.node_id and tecli.label_key = '" +
                    label2 + "' where ( '" + value2  +
                    "' = ANY(string_to_array(tecli.label_value,','))))");
            return (Criteria) this;
        ...
        public Criteria andLabelIsEmptyOrEqualTo(String label, String value, TblEdgeComputeInfoExample tblEdgeComputeInfoExample) {
            StringBuilder condition = new StringBuilder();
            condition.append("node_id in (SELECT teci.node_id FROM tbl_edge_compute_info teci LEFT JOIN ")
                    .append("tbl_edge_compute_label_info tecli ON teci.node_id = tecli.node_id and tecli.label_key = '")
                    .append(label).append("' where (tecli.label_value is null or '").append(value)
                    .append("' = ANY(string_to_array(tecli.label_value,',')))");
            if (StringUtils.isEmpty(tblEdgeComputeInfoExample.getOrderByClause()))
            {
                condition.append(" order by ").append(tblEdgeComputeInfoExample.getOrderByClause());
            }
            if (tblEdgeComputeInfoExample.getPageSize()>0)
            {
                condition.append(" limit ").append(tblEdgeComputeInfoExample.getPageSize()).append(" offset ")
                        .append(tblEdgeComputeInfoExample.getStartRow());
            }
            condition.append(")");

            addCriterion(condition.toString());
            return (Criteria) this;
        }
    }
