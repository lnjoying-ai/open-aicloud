...
public enum InstanceState
{
    ...
    EDGE_UNREACHABLE             ("EDGE_UNREACHABLE",            50,   "创建失败"   ,"create failed"),       //cloud fin state 50-99
    ...
    QUEUEING                     ("QUEUEING",                    100,  "创建中"    ,"creating"),       //used by edge 100~200
