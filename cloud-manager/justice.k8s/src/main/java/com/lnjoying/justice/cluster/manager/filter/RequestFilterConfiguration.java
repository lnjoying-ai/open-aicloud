package com.lnjoying.justice.cluster.manager.filter;
...
public class RequestFilterConfiguration
{
    ...
    public FilterRegistrationBean<OncePerRequestFilter> authFilterRegistrationBean()
    {
        ...
        registration.addUrlPatterns("/cls/v1/*");
    ...
    @Bean
    public FilterRegistrationBean<OncePerRequestFilter> accessFilterRegistrationBean()
    {
        FilterRegistrationBean<OncePerRequestFilter> registration = new FilterRegistrationBean<>();
