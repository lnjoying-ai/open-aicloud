...
public class DataSourceConfig
{
    ...
    static final String PACKAGE = "com.lnjoying.justice.cis.db";
...
//            RedisClientUtils.init("cis", redisConfig.getHost(), redisConfig.getPort(), redisConfig.getPassword(), redisConfig.getClientcount());
