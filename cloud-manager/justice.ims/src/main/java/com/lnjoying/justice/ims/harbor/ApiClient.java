package com.lnjoying.justice.ims.harbor;
...
import com.lnjoying.justice.ims.harbor.auth.Authentication;
import com.lnjoying.justice.ims.harbor.auth.HttpBasicAuth;
import com.lnjoying.justice.ims.harbor.auth.ApiKeyAuth;
import com.lnjoying.justice.ims.harbor.auth.OAuth;

import javax.net.ssl.SSLContext;

@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2021-08-31T16:17:12.981+08:00")
@Component("com.lnjoying.justice.ims.harbor.ApiClient")
public class ApiClient
{
    public static final String API_PATH = "api";

    public static final String V2_PATH = "/api/v2.0";
    ...
    public ApiClient(String basePath, String username, String password)
    {
    ...
    private static final RestTemplateResponseErrorHandler responseErrorHandler = new RestTemplateResponseErrorHandler();
    ...
    protected void init()
    {
        ...
        httpBasicAuth.setUsername(this.username);
        httpBasicAuth.setPassword(this.password);
        authentications.put("basic", httpBasicAuth);
    ...
    public static String buildHTTPSRequestUrl(String host)
    {
        return SCHEMA_HTTPS + "://" + host + V2_PATH;
    }

    public static String buildHTTPRequestUrl(String host)
    {
        return SCHEMA_HTTP + "://" + host + V2_PATH;
    }

    public static String buildRepoHTTPSRequestUrl(String host)
    {
        int chartrepo = host.indexOf("chartrepo");
        return host.substring(0, chartrepo) + API_PATH;
    }
    ...
    private ResponseErrorHandler setErrorHandler()
    {
