...
import static com.lnjoying.justice.ims.config.DataSourceConfig.TYPE_HANDLERS_PACKAGE;
...
public class DataSourceFactory
{
    ...
    public static SqlSessionFactory createSqlSessionFactory(DataSource dataSource, String map_location) throws Exception
    {
        ...
        sessionFactory.setTypeAliasesPackage("com.lnjoying.justice.ims.db.mapper");
