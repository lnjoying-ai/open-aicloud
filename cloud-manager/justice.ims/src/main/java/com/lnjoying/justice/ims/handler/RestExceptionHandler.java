...
public class RestExceptionHandler
{
     ...
     * @return
     */
    private Map<java.lang.String, Object> getValidError(List<FieldError> fieldErrors)
    {
        Map<java.lang.String, Object> result = new HashMap<String, Object>(16);
        List<java.lang.String> errorList = new ArrayList<String>();
