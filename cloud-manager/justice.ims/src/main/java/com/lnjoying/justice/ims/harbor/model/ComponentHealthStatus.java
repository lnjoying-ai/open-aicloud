...
public class ComponentHealthStatus
{
    ...
    public boolean equals(Object o)
    {
        ...
        return Objects.equals(this.status, componentHealthStatus.status) &&
                Objects.equals(this.name, componentHealthStatus.name) &&
    ...
    public int hashCode()
    {
        return Objects.hash(status, name, error);
    }
