...
@ApiModel(value = "TblCmpNfs")
public class TblCmpNfs extends TblCmpNfsKey implements Serializable {
    ...
    public String getNfsIdFromAgent() {
        return nfsIdFromAgent;
    }

    public void setNfsIdFromAgent(String nfsIdFromAgent) {
        this.nfsIdFromAgent = nfsIdFromAgent == null ? null : nfsIdFromAgent.trim();
    }
