...
@ApiModel(value = "TblCmpVolume")
public class TblCmpVolume extends TblCmpVolumeKey implements Serializable {
    ...
    public String getVolumeIdFromAgent() {
        return volumeIdFromAgent;
    }

    public void setVolumeIdFromAgent(String volumeIdFromAgent) {
        this.volumeIdFromAgent = volumeIdFromAgent == null ? null : volumeIdFromAgent.trim();
    }
