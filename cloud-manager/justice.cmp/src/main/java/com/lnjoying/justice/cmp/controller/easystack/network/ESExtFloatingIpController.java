...
import com.lnjoying.justice.cmp.domain.dto.response.openstack.neutron.OSExtFloatingIpsWithDetailsRsp;
...
@RestSchema(schemaId = "esextensionfloatingip")
@RequestMapping("/cmp/v1/ESK/clouds/{cloud_id}/extension/v2.0/floatingips")
@Api(value = "OpenStack Floating Ip Controller",tags = "OpenStack Floating Ip Controller")
@ApiOperation(value = "", extensions = {@Extension(name = SWAGGER_X_RESOURCE,
        properties = {@ExtensionProperty(name = SWAGGER_RESOURCE_SINGULAR_NAME, value = "es_ext_floatingip"),
                @ExtensionProperty(name = SWAGGER_RESOURCE_PLURAL_NAME, value = "es_ext_floatingips"),
...
public class ESExtFloatingIpController extends RestWebController
{
    private static Logger LOGGER = LogManager.getLogger();

    @Autowired
    private ESFloatingIPService floatingIPService;
