...
@ApiModel(value = "TblCmpVmSnap")
public class TblCmpVmSnap extends TblCmpVmSnapKey implements Serializable {
    ...
    public String getSnapIdFromAgent() {
        return snapIdFromAgent;
    }

    public void setSnapIdFromAgent(String snapIdFromAgent) {
        this.snapIdFromAgent = snapIdFromAgent == null ? null : snapIdFromAgent.trim();
    }
