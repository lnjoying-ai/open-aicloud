...
public class OSExtPortInfo
{
    ...
    @JsonProperty("subnet_allocation_pools")
    @SerializedName("subnet_allocation_pools")
            ...
            for (TblCmpOsIpallocations tblCmpOsIpallocation : tblCmpOsIpallocations)
            {
                ...
                if (tblCmpOsIpallocation.getIpAddress() != null)
                {
                    if (tblCmpOsIpallocation.getIpAddress().contains(":"))
                    {
                        ...
                        this.ipv6.add(tblCmpOsIpallocation.getIpAddress());
                    }
                    else if (tblCmpOsIpallocation.getIpAddress().contains("."))
                    {
                        fixedIp.setIpVersion(4);
                        this.ipv4.add(tblCmpOsIpallocation.getIpAddress());
                    }
                }
    ...
    public void setNetwork(TblCmpOsNetworks tblCmpOsNetwork)
    {
        if (tblCmpOsNetwork != null)
        {
            ...
            this.networkName = tblCmpOsNetwork.getName();
    ...
    public void setSubnet(TblCmpOsSubnets tblCmpOsSubnet)
    {
        if (tblCmpOsSubnet != null)
        {
            ...
            this.subnetCidr = tblCmpOsSubnet.getCidr();
        }
    }
