...
public class DataSourceFactory
{
    ...
    public static DruidDataSource createDruidDatSsource(JdbcConfig jdbcConfig)
    {
    ...
    public static SqlSessionFactory createSqlSessionFactory(DataSource dataSource, String map_location) throws Exception
    {
        ...
        sessionFactory.setTypeAliasesPackage("com.lnjoying.justice.servicemanager.db.mapper");
