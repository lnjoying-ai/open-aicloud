package com.lnjoying.justice.iam.authz.opa.gen;// Generated from E:/feng/2023/5/java/antlr-rego/antlr-rego/src/antlr\RegoLexer.g4 by ANTLR 4.12.0
...
public class RegoLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"Comment", "SomeComment", "DoubleQuote", "BackTick", "QuotedString", 
			"RawString", "String", "UnicodeEscape", "Bool", "Null", "As", "Default", 
			"Else", "Import", "Package", "Not", "With", "Set", "LSBrace", "LCBrace", 
			"LParan", "RSBrace", "RCBrace", "RParan", "Mid", "FactorOperator", "Plus", 
			"Minus", "ArithOperator", "RelationOperator", "EqOper", "Comma", "Semicolon", 
			"Colon", "Ampersand", "Dot", "Whitespace", "Newline", "WhiteSpace", "LineEnd", 
			"WindowsLineEnd", "Name", "SomeA", "E", "Real", "UnsignedNumber", "AsciiLetter", 
			"DecimalDigit", "Char", "EscapeSequence", "SingleCharEscape"
		};
	}
