package com.lnjoying.justice.iam.domain.dto.response.user;
...
public class UserRsp extends UserBasicRsp {
    ...
    public void setResponse(TblUserInfo tblUserInfo)
    {
        ...
        this.setBpId(tblUserInfo.getBpId());
        //this.setBpName(tblUserInfo.get);
        ...
        this.setContactInfo(userContactInfo);
//        this.set_allowed(tblUserInfo.getIsAllowed());
     ...
     */
    public void setPermission(List<TblIamRole> rolePos)
    {
        List<RoleDto> roleDtos = new ArrayList<>();
        for (TblIamRole rolePo : rolePos)
        {
