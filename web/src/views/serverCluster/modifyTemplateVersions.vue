    ...
    <el-card class="box-card" shadow="never">
      ...
      <div class="text item">
        <el-form ref="form" :model="versionForm" label-width="150px">
          <el-form-item :label="$t('form.versionNumber') + ':'">
            <el-input
  ...
  methods: {
    init() {
      ...
      templatesVersions(this.$route.params.id).then((res) => {
        ...
        var data = this.$script.jkeconfigServicesCustom(
          JSON.parse(JSON.stringify(res.jke_config))
        );

        this.$refs.infoRef.jke_config = this.deepMerge(
    ...
    updateVersions() {
      ...
      var data = {
        ...
        jke_config: this.versionForm.jke_config,
      };
      reviseTemplatesVersions(
        this.detailMain.id,
        this.removePropertyOfNull(
